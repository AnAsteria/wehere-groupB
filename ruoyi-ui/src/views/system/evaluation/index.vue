<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="评价者id" prop="fromId">
        <el-input
      ...
      <el-form-item label="受评者id" prop="toId">
        <el-input
          v-model="queryParams.toId"
          placeholder="请输入受评者id"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="评价者id" prop="fromId">
          <el-input v-model="form.fromId" placeholder="请输入评价者id" />
        </el-form-item>
        <el-form-item label="受评者id" prop="toId">
          <el-input v-model="form.toId" placeholder="请输入受评者id" />
        </el-form-item>
        <el-form-item label="得分" prop="score">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        toId: [
          { required: true, message: "受评者id不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除评价系统编号为"' + ids + '"的数据项？').then(function() {
