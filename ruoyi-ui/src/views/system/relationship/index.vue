...
" align="center" prop="supervisorId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="督导id
" prop="supervisorId">
          <el-input v-model="form.supervisorId" placeholder="请输入督导id
" />
        </el-form-item>
      </el-form>
...
<script>
import { listRelationship, getRelationship, delRelationship, addRelationship, updateRelationship } from "@/api/system/relationship";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        supervisorId: [
          { required: true, message: "督导id不能为空", trigger: "blur" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除关系管理编号为"' + ids + '"的数据项？').then(function() {
